...
- Networking is one of Vagrant's limitation when provisioning on HyperV (https://developer.hashicorp.com/vagrant/docs/providers/hyperv/limitations)
- 
...
Use your favourite SSH terminal tool (putty). I use Poderosa.
